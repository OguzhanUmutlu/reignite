...
class ApplyJointForcePlugin(Plugin):
    def __init__(
        ...
        super().__init__(sdf_version=None, filename="gz-sim-apply-joint-force-system",
    ...
    def to_sdf(self, version: str | None = None) -> ET.Element:
        el = ET.Element("plugin", name=self.name if hasattr(self, 'name') else "gz::sim::systems::ApplyJointForce",
