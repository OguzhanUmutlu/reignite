...
class RFCommsPlugin(Plugin):
    ...
    def _from_sdf(cls, el: ET.Element, version: str):
        ...
        return cls(
            ...
            fading_exponent=float(fading_exponent_el.text) if fading_exponent_el is not None and fading_exponent_el.text is not None else None,
            ...
            noise_floor=float(noise_floor_el.text) if noise_floor_el is not None and noise_floor_el.text is not None else None,
        )

    def to_sdf(self, version: str | None = None) -> ET.Element:
        el = ET.Element("plugin", name=self.name if hasattr(self, 'name') else "gz::sim::systems::RFComms", filename="gz-sim-rf-comms-system")
