...
class Contact(_PrevContact):
    def __init__(
        ...
        super().__init__(stiffness=stiffness, dissipation=dissipation, plastic_coef_restitution=plastic_coef_restitution, plastic_impact_velocity=plastic_impact_velocity, static_friction=static_friction, dynamic_friction=dynamic_friction, viscous_friction=viscous_friction, override_impact_capture_velocity=override_impact_capture_velocity, override_stiction_transition_velocity=override_stiction_transition_velocity)
    ...
    def from_sdf(cls, el: ET.Element) -> "Contact":
        ...
        return cls(stiffness=_base.stiffness, dissipation=_base.dissipation, plastic_coef_restitution=_base.plastic_coef_restitution, plastic_impact_velocity=_base.plastic_impact_velocity, static_friction=_base.static_friction, dynamic_friction=_base.dynamic_friction, viscous_friction=_base.viscous_friction, override_impact_capture_velocity=_base.override_impact_capture_velocity, override_stiction_transition_velocity=_base.override_stiction_transition_velocity)
