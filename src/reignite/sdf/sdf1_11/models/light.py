...
from ...sdf1_10.models.light import Light as _PrevLight
...
class Light(_PrevLight):
    def __init__(
        ...
        super().__init__(name=name, type=type, pose=pose, cast_shadows=cast_shadows, light_on=light_on,
                         visualize=visualize, intensity=intensity, diffuse=diffuse, specular=specular,
    ...
    def from_sdf(cls, el: ET.Element) -> "Light":
        ...
        return cls(name=_base.name, type=_base.type, pose=_base.pose, cast_shadows=_base.cast_shadows,
                   light_on=_base.light_on, visualize=_base.visualize, intensity=_base.intensity, diffuse=_base.diffuse,
