...
from .sky import Sky
from ...sdf1_10.models.ambient import Ambient as _PrevAmbient
from ...sdf1_10.models.scene import Scene as _PrevScene
...
class Scene(_PrevScene):
    ...
    def from_sdf(cls, el: ET.Element) -> "Scene":
        ...
        return cls(ambient=_base.ambient, background=_base.background, sky=_base.sky, shadows=_base.shadows,
                   fog=_base.fog, grid=_base.grid, origin_visual=_base.origin_visual)
