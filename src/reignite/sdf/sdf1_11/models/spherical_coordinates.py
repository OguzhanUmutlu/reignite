...
from ...sdf1_10.models.spherical_coordinates import SphericalCoordinates as _PrevSphericalCoordinates
...
class SphericalCoordinates(_PrevSphericalCoordinates):
    def __init__(
        ...
        super().__init__(surface_model=surface_model, world_frame_orientation=world_frame_orientation, latitude_deg=latitude_deg, longitude_deg=longitude_deg, elevation=elevation, surface_axis_equatorial=surface_axis_equatorial, surface_axis_polar=surface_axis_polar, heading_deg=heading_deg)
