...
class Visual(_PrevVisual):
    def __init__(
        ...
        super().__init__(name=name, pose=pose, material=material, geometry=geometry, plugin=plugin,
                         ...
                         visibility_flags=visibility_flags, meta=meta)
    ...
    def from_sdf(cls, el: ET.Element) -> "Visual":
        ...
        return cls(name=_base.name, pose=_base.pose, material=_base.material, geometry=_base.geometry,
                   plugin=_base.plugin, cast_shadows=_base.cast_shadows, laser_retro=_base.laser_retro,
                   transparency=_base.transparency, visibility_flags=_base.visibility_flags, meta=_base.meta)
