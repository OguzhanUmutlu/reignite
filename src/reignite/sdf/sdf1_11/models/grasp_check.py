...
from ...sdf1_10.models.grasp_check import GraspCheck as _PrevGraspCheck
...
class GraspCheck(_PrevGraspCheck):
    ...
    def from_sdf(cls, el: ET.Element) -> "GraspCheck":
        ...
        return cls(detach_steps=_base.detach_steps, attach_steps=_base.attach_steps, min_contact_count=_base.min_contact_count)
