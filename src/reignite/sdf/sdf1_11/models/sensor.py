...
from ...sdf1_10.models.bullet import Bullet as _PrevBullet
from ...sdf1_10.models.contact import Contact as _PrevContact
from ...sdf1_10.models.ode import Ode as _PrevOde
from ...sdf1_10.models.sensor import Sensor as _PrevSensor
...
class Sensor(_PrevSensor):
    ...
    def from_sdf(cls, el: ET.Element) -> "Sensor":
        ...
        return cls(name=_base.name, type=_base.type, pose=_base.pose, plugin=_base.plugin,
                   ...
                   enable_metrics=_base.enable_metrics)
