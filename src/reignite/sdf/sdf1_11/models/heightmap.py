...
from ...sdf1_10.models.texture import Texture as _PrevTexture
from ...sdf1_10.models.heightmap import Heightmap as _PrevHeightmap
from .uri import Uri
...
class Heightmap(_PrevHeightmap):
    def __init__(
        ...
        super().__init__(uri=uri, size=size, pos=pos, texture=texture, blend=blend, use_terrain_paging=use_terrain_paging, sampling=sampling)
    ...
    def from_sdf(cls, el: ET.Element) -> "Heightmap":
        ...
        return cls(uri=_base.uri, size=_base.size, pos=_base.pos, texture=_base.texture, blend=_base.blend, use_terrain_paging=_base.use_terrain_paging, sampling=_base.sampling)
