...
from ...sdf1_10.models.frame import Frame as _PrevFrame
from ...sdf1_10.models.ode import Ode as _PrevOde
from ...sdf1_10.models.physics import Physics as _PrevPhysics
from ...sdf1_10.models.pose import Pose as _PrevPose
from ...sdf1_10.models.simbody import Simbody as _PrevSimbody
from ...sdf1_10.models.world import World as _PrevWorld
...
class World(_PrevWorld):
    def __init__(
        ...
        super().__init__(name=name, atmosphere=atmosphere, gui=gui, physics=physics, scene=scene, light=light,
                         frame=frame, joint=joint, model=model, actor=actor, plugin=plugin, road=road,
                         spherical_coordinates=spherical_coordinates, state=state, population=population, audio=audio,
                         wind=wind, include=include, gravity=gravity, magnetic_field=magnetic_field)
    ...
    def from_sdf(cls, el: ET.Element) -> "World":
        ...
        return cls(name=_base.name, atmosphere=_base.atmosphere, gui=_base.gui, physics=_base.physics,
                   scene=_base.scene, light=_base.light, frame=_base.frame, joint=_base.joint, model=_base.model,
                   actor=_base.actor, plugin=_base.plugin, road=_base.road,
                   spherical_coordinates=_base.spherical_coordinates, state=_base.state, population=_base.population,
                   audio=_base.audio, wind=_base.wind, include=_base.include, gravity=_base.gravity,
                   magnetic_field=_base.magnetic_field)
