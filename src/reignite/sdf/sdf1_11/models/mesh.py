...
class Mesh(_PrevMesh):
    ...
    def from_sdf(cls, el: ET.Element) -> "Mesh":
        ...
        _convex_decomposition = ConvexDecomposition.from_sdf(_c_convex_decomposition) if _c_convex_decomposition is not None else None
        return cls(optimization=_optimization, convex_decomposition=_convex_decomposition, uri=_base.uri, submesh=_base.submesh, scale=_base.scale)
