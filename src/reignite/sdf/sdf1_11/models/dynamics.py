...
from ...sdf1_10.models.dynamics import Dynamics as _PrevDynamics
...
class Dynamics(_PrevDynamics):
    def __init__(
        ...
        super().__init__(damping=damping, friction=friction, spring_reference=spring_reference,
    ...
    def from_sdf(cls, el: ET.Element) -> "Dynamics":
        ...
        return cls(damping=_base.damping, friction=_base.friction, spring_reference=_base.spring_reference,
                   spring_stiffness=_base.spring_stiffness)
