...
class Gripper(BaseModel):
    class GraspCheck(BaseModel):
        class AttachSteps(BaseModel):
            def __init__(self, sdf_version: str | None = None, attach_steps: int = 20):
                super().__init__(sdf_version)
                self.attach_steps = attach_steps

            def to_version(self, target_version: str) -> "Gripper.GraspCheck.AttachSteps":
            ...
            @classmethod
            def _from_sdf(cls, el: ET.Element, version: str) -> "Gripper.GraspCheck.AttachSteps | SDFError":
                _text = el.text or 20
        ...
        class DetachSteps(BaseModel):
            def __init__(self, sdf_version: str | None = None, detach_steps: int = 40):
                super().__init__(sdf_version)
                self.detach_steps = detach_steps

            def to_version(self, target_version: str) -> "Gripper.GraspCheck.DetachSteps":
            ...
            @classmethod
            def _from_sdf(cls, el: ET.Element, version: str) -> "Gripper.GraspCheck.DetachSteps | SDFError":
                _text = el.text or 40
        ...
        class MinContactCount(BaseModel):
            def __init__(self, sdf_version: str | None = None, min_contact_count: int = 2):
                super().__init__(sdf_version)
                self.min_contact_count = min_contact_count

            def to_version(self, target_version: str) -> "Gripper.GraspCheck.MinContactCount":
            ...
            @classmethod
            def _from_sdf(cls, el: ET.Element, version: str) -> "Gripper.GraspCheck.MinContactCount | SDFError":
                _text = el.text or 2
    ...
    class GripperLink(BaseModel):
        def __init__(self, sdf_version: str | None = None, gripper_link: str = "__default__"):
            super().__init__(sdf_version)
            self.gripper_link = gripper_link

        def to_version(self, target_version: str) -> "Gripper.GripperLink":
            kwargs = {"sdf_version": target_version}
        ...
        @classmethod
        def _from_sdf(cls, el: ET.Element, version: str) -> "Gripper.GripperLink | SDFError":
    ...
    class PalmLink(BaseModel):
        def __init__(self, sdf_version: str | None = None, palm_link: str = "__default__"):
            super().__init__(sdf_version)
            self.palm_link = palm_link

        def to_version(self, target_version: str) -> "Gripper.PalmLink":
            kwargs = {"sdf_version": target_version}
        ...
        @classmethod
        def _from_sdf(cls, el: ET.Element, version: str) -> "Gripper.PalmLink | SDFError":
            _text = el.text or "__default__"
            _palm_link = _text
    ...
    def __init__(
        ...
        gripper_links: List["Gripper.GripperLink"] = None,
        name: str = "__default__",
        palm_link: "Gripper.PalmLink" = None
    ):
        super().__init__(sdf_version)
        ...
        if self.palm_link is not None:
            ...
            elif getattr(self.palm_link, '__version__', None) != self.__version__ and self.__version__ is not None:
                self.palm_link = self.palm_link.to_version(self.__version__)
    ...
    def _from_sdf(cls, el: ET.Element, version: str) -> "Gripper | SDFError":
        ...
        for c in el.findall("gripper_link"):
            _res = cls.GripperLink._from_sdf(c, version)
            if isinstance(_res, SDFError):
        ...
        if _c_palm_link is not None:
            _res = cls.PalmLink._from_sdf(_c_palm_link, version)
            if isinstance(_res, SDFError):
