...
class SphericalCoordinates(_PrevSphericalCoordinates):
    ...
    def from_sdf(cls, el: ET.Element) -> "SphericalCoordinates":
        ...
        _world_frame_orientation = WorldFrameOrientation.from_sdf(
            _c_world_frame_orientation) if _c_world_frame_orientation is not None else None
        return cls(surface_model=_base.surface_model, world_frame_orientation=_world_frame_orientation,
