...
class Population(_PrevPopulation):
    def __init__(
        ...
        super().__init__(name=name, box=box, cylinder=cylinder, frame=frame, pose=pose, model=model, model_count=model_count, distribution=distribution)
    ...
    def from_sdf(cls, el: ET.Element) -> "Population":
        ...
        return cls(name=_base.name, box=_base.box, cylinder=_base.cylinder, frame=_base.frame, pose=_base.pose, model=_base.model, model_count=_base.model_count, distribution=_base.distribution)
