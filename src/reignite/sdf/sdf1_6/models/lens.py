...
class Lens(_PrevLens):
    def __init__(
        ...
        super().__init__(type=type, scale_to_hfov=scale_to_hfov, custom_function=custom_function,
                         cutoff_angle=cutoff_angle, env_texture_size=env_texture_size)
    ...
    def from_sdf(cls, el: ET.Element) -> "Lens":
        ...
        return cls(type=_base.type, scale_to_hfov=_base.scale_to_hfov, custom_function=_base.custom_function,
                   cutoff_angle=_base.cutoff_angle, env_texture_size=_base.env_texture_size, intrinsics=_intrinsics)
