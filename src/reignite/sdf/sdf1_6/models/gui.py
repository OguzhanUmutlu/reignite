...
from ...sdf1_5.models.gui import Gui as _PrevGui
...
class Camera(_PrevCamera):
    def __init__(
        ...
        super().__init__(name=name, frame=frame, pose=pose)
    ...
    def from_sdf(cls, el: ET.Element) -> "Camera":
        ...
        return cls(name=_base.name, frame=_base.frame, pose=_base.pose, view_controller=_view_controller, projection_type=_projection_type, track_visual=_track_visual)
