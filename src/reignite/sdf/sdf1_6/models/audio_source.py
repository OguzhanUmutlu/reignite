...
from ...sdf1_5.models.audio_source import AudioSource as _PrevAudioSource
...
class AudioSource(_PrevAudioSource):
    def __init__(
        ...
        super().__init__(frame=frame, pose=pose, uri=uri, pitch=pitch, gain=gain, contact=contact, loop=loop)
    ...
    def from_sdf(cls, el: ET.Element) -> "AudioSource":
        ...
        return cls(frame=_base.frame, pose=_base.pose, uri=_base.uri, pitch=_base.pitch, gain=_base.gain, contact=_base.contact, loop=_base.loop)
