...
class Noise(_PrevNoise):
    ...
    def from_sdf(cls, el: ET.Element) -> "Noise":
        ...
        return cls(type=_base.type, mean=_base.mean, stddev=_base.stddev, bias_mean=_base.bias_mean,
                   bias_stddev=_base.bias_stddev, dynamic_bias_stddev=_dynamic_bias_stddev,
                   dynamic_bias_correlation_time=_dynamic_bias_correlation_time, precision=_base.precision)
