...
class Camera(_PrevCamera):
    def __init__(
        ...
        super().__init__(name=name, frame=frame, pose=pose, horizontal_fov=horizontal_fov, image=image, clip=clip, save=save, depth_camera=depth_camera, noise=noise, distortion=distortion, lens=lens)
    ...
    def from_sdf(cls, el: ET.Element) -> "Camera":
        ...
        return cls(name=_base.name, frame=_base.frame, pose=_base.pose, horizontal_fov=_base.horizontal_fov, image=_base.image, clip=_base.clip, save=_base.save, depth_camera=_base.depth_camera, noise=_base.noise, distortion=_base.distortion, lens=_base.lens)
