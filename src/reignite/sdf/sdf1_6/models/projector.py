...
class Projector(_PrevProjector):
    def __init__(
        ...
        super().__init__(name=name, frame=frame, pose=pose, plugin=plugin, texture=texture, fov=fov,
    ...
    def from_sdf(cls, el: ET.Element) -> "Projector":
        ...
        return cls(name=_base.name, frame=_base.frame, pose=_base.pose, plugin=_base.plugin, texture=_base.texture,
                   fov=_base.fov, near_clip=_base.near_clip, far_clip=_base.far_clip)
