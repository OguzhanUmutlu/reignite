...
class Imu(_PrevImu):
    ...
    def from_sdf(cls, el: ET.Element) -> "Imu":
        ...
        _orientation_reference_frame = OrientationReferenceFrame.from_sdf(_c_orientation_reference_frame) if _c_orientation_reference_frame is not None else None
        _c_enable_orientation = el.find("enable_orientation")
        _enable_orientation = EnableOrientation.from_sdf(_c_enable_orientation) if _c_enable_orientation is not None else None
        return cls(orientation_reference_frame=_orientation_reference_frame, topic=_base.topic, angular_velocity=_base.angular_velocity, linear_acceleration=_base.linear_acceleration, enable_orientation=_enable_orientation)
