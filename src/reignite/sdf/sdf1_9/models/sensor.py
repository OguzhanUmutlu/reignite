...
from ...sdf1_8.models.contact import Contact as _PrevContact
from ...sdf1_8.models.ode import Ode as _PrevOde
from ...sdf1_8.models.sensor import Sensor as _PrevSensor
...
class Sensor(_PrevSensor):
    ...
    def from_sdf(cls, el: ET.Element) -> "Sensor":
        ...
        return cls(name=_base.name, type=_base.type, pose=_base.pose, plugin=_base.plugin,
                   ...
                   navsat=_base.navsat, ray=_base.ray, rfidtag=_base.rfidtag, rfid=_base.rfid, sonar=_base.sonar,
                   transceiver=_base.transceiver, always_on=_base.always_on, update_rate=_base.update_rate,
                   visualize=_base.visualize, topic=_base.topic, enable_metrics=_base.enable_metrics)
