...
class World(_PrevWorld):
    def __init__(
        ...
        super().__init__(name=name, atmosphere=atmosphere, gui=gui, physics=physics, scene=scene, light=light, frame=frame, model=model, actor=actor, plugin=plugin, road=road, spherical_coordinates=spherical_coordinates, state=state, population=population, audio=audio, wind=wind, include=include, gravity=gravity, magnetic_field=magnetic_field)
