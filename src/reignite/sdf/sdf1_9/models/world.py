...
from ...sdf1_8.models.dart import Dart as _PrevDart
from ...sdf1_8.models.frame import Frame as _PrevFrame
from ...sdf1_8.models.ode import Ode as _PrevOde
from ...sdf1_8.models.physics import Physics as _PrevPhysics
from ...sdf1_8.models.pose import Pose as _PrevPose
from ...sdf1_8.models.simbody import Simbody as _PrevSimbody
from ...sdf1_8.models.world import World as _PrevWorld
...
class World(_PrevWorld):
    def __init__(
        ...
        super().__init__(name=name, atmosphere=atmosphere, gui=gui, physics=physics, scene=scene, light=light,
                         frame=frame, model=model, actor=actor, plugin=plugin, road=road,
    ...
    def from_sdf(cls, el: ET.Element) -> "World":
        ...
        return cls(name=_base.name, atmosphere=_base.atmosphere, gui=_base.gui, physics=_base.physics,
                   scene=_base.scene, light=_base.light, frame=_base.frame, model=_base.model, actor=_base.actor,
