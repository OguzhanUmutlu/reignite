...
class Model(_PrevModel):
    ...
    def from_sdf(cls, el: ET.Element) -> "Model":
        ...
        return cls(name=_base.name, canonical_link=_canonical_link, frame=_frame, pose=_pose, link=_link, joint=_joint,
                   plugin=_plugin, gripper=_gripper, static=_static, self_collide=_self_collide,
                   allow_auto_disable=_allow_auto_disable, include=_include, model=_model, enable_wind=_enable_wind)
