...
class Camera(_PrevCamera):
    def __init__(
        ...
        super().__init__(name=name, pose=pose, horizontal_fov=horizontal_fov, image=image, clip=clip, save=save,
                         depth_camera=depth_camera, noise=noise, distortion=distortion, lens=lens)
    ...
    def from_sdf(cls, el: ET.Element) -> "Camera":
        ...
        _camera_info_topic = CameraInfoTopic.from_sdf(
            _c_camera_info_topic) if _c_camera_info_topic is not None else None
        ...
        return cls(name=_base.name, pose=_base.pose, camera_info_topic=_camera_info_topic,
                   horizontal_fov=_base.horizontal_fov, image=_base.image, clip=_base.clip, save=_base.save,
                   depth_camera=_base.depth_camera, noise=_base.noise, distortion=_base.distortion, lens=_base.lens,
                   visibility_mask=_visibility_mask, optical_frame_id=_optical_frame_id)
