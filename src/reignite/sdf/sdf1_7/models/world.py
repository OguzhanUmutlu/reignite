...
from ...sdf1_6.models.dart import Dart as _PrevDart
from ...sdf1_6.models.frame import Frame as _PrevFrame
from ...sdf1_6.models.ode import Ode as _PrevOde
from ...sdf1_6.models.physics import Physics as _PrevPhysics
from ...sdf1_6.models.pose import Pose as _PrevPose
from ...sdf1_6.models.simbody import Simbody as _PrevSimbody
from ...sdf1_6.models.world import World as _PrevWorld
...
class Frame(_PrevFrame):
    ...
    def from_sdf(cls, el: ET.Element) -> "Frame":
        ...
        return cls(name=_base.name, attached_to=_attached_to, pose=_base.pose)
...
class World(_PrevWorld):
    def __init__(
        ...
        super().__init__(name=name, atmosphere=atmosphere, gui=gui, physics=physics, scene=scene, light=light,
                         model=model, actor=actor, plugin=plugin, road=road,
    ...
    def from_sdf(cls, el: ET.Element) -> "World":
        ...
        return cls(name=_base.name, atmosphere=_base.atmosphere, gui=_base.gui, physics=_base.physics,
                   scene=_base.scene, light=_base.light, frame=_frame, model=_base.model, actor=_base.actor,
                   plugin=_base.plugin, road=_base.road, spherical_coordinates=_base.spherical_coordinates,
                   state=_base.state, population=_base.population, audio=_base.audio, wind=_base.wind,
                   include=_base.include, gravity=_base.gravity, magnetic_field=_base.magnetic_field)
