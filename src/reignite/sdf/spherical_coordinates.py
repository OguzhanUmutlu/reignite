...
class SphericalCoordinates(BaseModel):
    class Elevation(BaseModel):
        ...
        def to_version(self, target_version: str) -> "SphericalCoordinates.Elevation":
        ...
        @classmethod
        def _from_sdf(cls, el: ET.Element, version: str) -> "SphericalCoordinates.Elevation | SDFError":
    ...
    class HeadingDeg(BaseModel):
        ...
        def to_version(self, target_version: str) -> "SphericalCoordinates.HeadingDeg":
            kwargs = {"sdf_version": target_version}
        ...
        @classmethod
        def _from_sdf(cls, el: ET.Element, version: str) -> "SphericalCoordinates.HeadingDeg | SDFError":
            _text = el.text or 0.0
    ...
    class LatitudeDeg(BaseModel):
        ...
        def to_version(self, target_version: str) -> "SphericalCoordinates.LatitudeDeg":
            kwargs = {"sdf_version": target_version}
        ...
        @classmethod
        def _from_sdf(cls, el: ET.Element, version: str) -> "SphericalCoordinates.LatitudeDeg | SDFError":
            _text = el.text or 0.0
    ...
    class LongitudeDeg(BaseModel):
        ...
        def to_version(self, target_version: str) -> "SphericalCoordinates.LongitudeDeg":
            kwargs = {"sdf_version": target_version}
        ...
        @classmethod
        def _from_sdf(cls, el: ET.Element, version: str) -> "SphericalCoordinates.LongitudeDeg | SDFError":
            _text = el.text or 0.0
    ...
    class SurfaceAxisEquatorial(BaseModel):
        ...
        def to_version(self, target_version: str) -> "SphericalCoordinates.SurfaceAxisEquatorial":
        ...
        @classmethod
        def _from_sdf(cls, el: ET.Element, version: str) -> "SphericalCoordinates.SurfaceAxisEquatorial | SDFError":
            _text = el.text or 0.0
    ...
    class SurfaceAxisPolar(BaseModel):
        ...
        def to_version(self, target_version: str) -> "SphericalCoordinates.SurfaceAxisPolar":
        ...
        @classmethod
        def _from_sdf(cls, el: ET.Element, version: str) -> "SphericalCoordinates.SurfaceAxisPolar | SDFError":
            _text = el.text or 0.0
    ...
    class SurfaceModel(BaseModel):
        ...
        def to_version(self, target_version: str) -> "SphericalCoordinates.SurfaceModel":
            kwargs = {"sdf_version": target_version}
        ...
        @classmethod
        def _from_sdf(cls, el: ET.Element, version: str) -> "SphericalCoordinates.SurfaceModel | SDFError":
    ...
    class WorldFrameOrientation(BaseModel):
        ...
        def to_version(self, target_version: str) -> "SphericalCoordinates.WorldFrameOrientation":
        ...
        @classmethod
        def _from_sdf(cls, el: ET.Element, version: str) -> "SphericalCoordinates.WorldFrameOrientation | SDFError":
    ...
    def __init__(
        ...
        elevation: "SphericalCoordinates.Elevation" = None,
        heading_deg: "SphericalCoordinates.HeadingDeg" = None,
        latitude_deg: "SphericalCoordinates.LatitudeDeg" = None,
        longitude_deg: "SphericalCoordinates.LongitudeDeg" = None,
        surface_axis_equatorial: "SphericalCoordinates.SurfaceAxisEquatorial" = None,
        surface_axis_polar: "SphericalCoordinates.SurfaceAxisPolar" = None,
        surface_model: "SphericalCoordinates.SurfaceModel" = None,
        world_frame_orientation: "SphericalCoordinates.WorldFrameOrientation" = None
    ):
        super().__init__(sdf_version)
        self.elevation = elevation
        self.heading_deg = heading_deg
    ...
    def _from_sdf(cls, el: ET.Element, version: str) -> "SphericalCoordinates | SDFError":
        ...
        if _c_elevation is not None:
            _res = cls.Elevation._from_sdf(_c_elevation, version)
        ...
        if _c_heading_deg is not None:
            _res = cls.HeadingDeg._from_sdf(_c_heading_deg, version)
            if isinstance(_res, SDFError):
        ...
        if _c_latitude_deg is not None:
            _res = cls.LatitudeDeg._from_sdf(_c_latitude_deg, version)
            if isinstance(_res, SDFError):
        ...
        if _c_longitude_deg is not None:
            _res = cls.LongitudeDeg._from_sdf(_c_longitude_deg, version)
            if isinstance(_res, SDFError):
        ...
        if _c_surface_axis_equatorial is not None:
            _res = cls.SurfaceAxisEquatorial._from_sdf(_c_surface_axis_equatorial, version)
            if isinstance(_res, SDFError):
        ...
        if _c_surface_axis_polar is not None:
            _res = cls.SurfaceAxisPolar._from_sdf(_c_surface_axis_polar, version)
            if isinstance(_res, SDFError):
        ...
        if _c_surface_model is not None:
            _res = cls.SurfaceModel._from_sdf(_c_surface_model, version)
            if isinstance(_res, SDFError):
        ...
        if _c_world_frame_orientation is not None:
            _res = cls.WorldFrameOrientation._from_sdf(_c_world_frame_orientation, version)
            if isinstance(_res, SDFError):
