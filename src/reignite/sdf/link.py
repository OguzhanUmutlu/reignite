...
class Sampling(Model):
    ...
    def from_sdf(cls, el: ET.Element, version: str) -> "Sampling":
        ...
        if _sampling is not None and cmp_version(version, "1.12") < 0:
            if _sampling != 1:
                raise ValueError(f"'sampling' is not supported in SDF version {version} (added in 1.12)")
...
class Geometry(Model):
    ...
    def from_sdf(cls, el: ET.Element, version: str) -> "Geometry":
        ...
        if _polyline is not None and cmp_version(version, "1.12") < 0:
            raise ValueError(f"'polyline' is not supported in SDF version {version} (added in 1.12)")
        return cls(sdf_version=version, box=_box, sphere=_sphere, cylinder=_cylinder, mesh=_mesh, plane=_plane, image=_image, heightmap=_heightmap, empty=_empty, capsule=_capsule, cone=_cone, ellipsoid=_ellipsoid, polyline=_polyline)
...
class Friction(Model):
    ...
    def from_sdf(cls, el: ET.Element, version: str) -> "Friction":
        ...
        if _torsional is not None and cmp_version(version, "1.12") < 0:
            raise ValueError(f"'torsional' is not supported in SDF version {version} (added in 1.12)")
    ...
    def from_sdf(cls, el: ET.Element, version: str) -> "CategoryBitmask":
        ...
        if _category_bitmask is not None and cmp_version(version, "1.12") < 0:
            if _category_bitmask != 65535:
                raise ValueError(f"'category_bitmask' is not supported in SDF version {version} (added in 1.12)")
    ...
    def from_sdf(cls, el: ET.Element, version: str) -> "PoissonsRatio":
        ...
        if _poissons_ratio is not None and cmp_version(version, "1.12") < 0:
            if _poissons_ratio != 0.3:
                raise ValueError(f"'poissons_ratio' is not supported in SDF version {version} (added in 1.12)")
    ...
    def from_sdf(cls, el: ET.Element, version: str) -> "ElasticModulus":
        ...
        if _elastic_modulus is not None and cmp_version(version, "1.12") < 0:
            if _elastic_modulus != -1:
                raise ValueError(f"'elastic_modulus' is not supported in SDF version {version} (added in 1.12)")
    ...
    def from_sdf(cls, el: ET.Element, version: str) -> "RenderOrder":
        ...
        if _render_order is not None and cmp_version(version, "1.12") < 0:
            if _render_order != 0.0:
                raise ValueError(f"'render_order' is not supported in SDF version {version} (added in 1.12)")
...
class Shininess(Model):
    ...
    def from_sdf(cls, el: ET.Element, version: str) -> "Shininess":
        ...
        if _shininess is not None and cmp_version(version, "1.12") < 0:
            if _shininess != 0:
                raise ValueError(f"'shininess' is not supported in SDF version {version} (added in 1.12)")
    ...
    def from_sdf(cls, el: ET.Element, version: str) -> "DoubleSided":
        ...
        if _double_sided is not None and cmp_version(version, "1.12") < 0:
            if _double_sided != False:
                raise ValueError(f"'double_sided' is not supported in SDF version {version} (added in 1.12)")
...
class Material(Model):
    ...
    def from_sdf(cls, el: ET.Element, version: str) -> "Material":
        ...
        if _pbr is not None and cmp_version(version, "1.12") < 0:
            raise ValueError(f"'pbr' is not supported in SDF version {version} (added in 1.12)")
    ...
    def from_sdf(cls, el: ET.Element, version: str) -> "VisibilityFlags":
        ...
        if _visibility_flags is not None and cmp_version(version, "1.12") < 0:
            if _visibility_flags != 4294967295:
                raise ValueError(f"'visibility_flags' is not supported in SDF version {version} (added in 1.12)")
...
class Visual(Model):
    ...
    def from_sdf(cls, el: ET.Element, version: str) -> "Visual":
        ...
        if _meta is not None and cmp_version(version, "1.12") < 0:
            raise ValueError(f"'meta' is not supported in SDF version {version} (added in 1.12)")
...
class DepthCamera(Model):
    ...
    def from_sdf(cls, el: ET.Element, version: str) -> "DepthCamera":
        ...
        if _clip is not None and cmp_version(version, "1.12") < 0:
            raise ValueError(f"'clip' is not supported in SDF version {version} (added in 1.12)")
    ...
    def from_sdf(cls, el: ET.Element, version: str) -> "CameraInfoTopic":
        ...
        if _camera_info_topic is not None and cmp_version(version, "1.12") < 0:
            if _camera_info_topic != "__default__":
                raise ValueError(f"'camera_info_topic' is not supported in SDF version {version} (added in 1.12)")
    ...
    def from_sdf(cls, el: ET.Element, version: str) -> "OpticalFrameId":
        ...
        if _optical_frame_id is not None and cmp_version(version, "1.12") < 0:
            if _optical_frame_id != "":
                raise ValueError(f"'optical_frame_id' is not supported in SDF version {version} (added in 1.12)")
...
class Camera(Model):
    ...
    def from_sdf(cls, el: ET.Element, version: str) -> "Camera":
        ...
        if _distortion is not None and cmp_version(version, "1.12") < 0:
            raise ValueError(f"'distortion' is not supported in SDF version {version} (added in 1.12)")
        ...
        if _lens is not None and cmp_version(version, "1.12") < 0:
            raise ValueError(f"'lens' is not supported in SDF version {version} (added in 1.12)")
        ...
        if _optical_frame_id is not None and cmp_version(version, "1.12") < 0:
            raise ValueError(f"'optical_frame_id' is not supported in SDF version {version} (added in 1.12)")
        return cls(sdf_version=version, name=_name, horizontal_fov=_horizontal_fov, image=_image, clip=_clip, save=_save, depth_camera=_depth_camera, pose=_pose, noise=_noise, triggered=_triggered, camera_info_topic=_camera_info_topic, trigger_topic=_trigger_topic, segmentation_type=_segmentation_type, box_type=_box_type, distortion=_distortion, lens=_lens, visibility_mask=_visibility_mask, optical_frame_id=_optical_frame_id)
    ...
    def from_sdf(cls, el: ET.Element, version: str) -> "EnableOrientation":
        ...
        if _enable_orientation is not None and cmp_version(version, "1.12") < 0:
            if _enable_orientation != True:
                raise ValueError(f"'enable_orientation' is not supported in SDF version {version} (added in 1.12)")
...
class Imu(Model):
    ...
    def from_sdf(cls, el: ET.Element, version: str) -> "Imu":
        ...
        if _orientation_reference_frame is not None and cmp_version(version, "1.12") < 0:
            raise ValueError(f"'orientation_reference_frame' is not supported in SDF version {version} (added in 1.12)")
        ...
        if _angular_velocity is not None and cmp_version(version, "1.12") < 0:
            raise ValueError(f"'angular_velocity' is not supported in SDF version {version} (added in 1.12)")
        ...
        if _linear_acceleration is not None and cmp_version(version, "1.12") < 0:
            raise ValueError(f"'linear_acceleration' is not supported in SDF version {version} (added in 1.12)")
    ...
    def from_sdf(cls, el: ET.Element, version: str) -> "MeasureDirection":
        ...
        if _measure_direction is not None and cmp_version(version, "1.12") < 0:
            if _measure_direction != "child_to_parent":
                raise ValueError(f"'measure_direction' is not supported in SDF version {version} (added in 1.12)")
...
class ForceTorque(Model):
    ...
    def from_sdf(cls, el: ET.Element, version: str) -> "ForceTorque":
        ...
        if _force is not None and cmp_version(version, "1.12") < 0:
            raise ValueError(f"'force' is not supported in SDF version {version} (added in 1.12)")
        ...
        if _torque is not None and cmp_version(version, "1.12") < 0:
            raise ValueError(f"'torque' is not supported in SDF version {version} (added in 1.12)")
...
class Sonar(Model):
    ...
    def from_sdf(cls, el: ET.Element, version: str) -> "Sonar":
        ...
        if _geometry is not None and cmp_version(version, "1.12") < 0:
            raise ValueError(f"'geometry' is not supported in SDF version {version} (added in 1.12)")
    ...
    def from_sdf(cls, el: ET.Element, version: str) -> "EnableMetrics":
        ...
        if _enable_metrics is not None and cmp_version(version, "1.12") < 0:
            if _enable_metrics != False:
                raise ValueError(f"'enable_metrics' is not supported in SDF version {version} (added in 1.12)")
...
class Sensor(Model):
    ...
    def from_sdf(cls, el: ET.Element, version: str) -> "Sensor":
        ...
        if _air_pressure is not None and cmp_version(version, "1.12") < 0:
            raise ValueError(f"'air_pressure' is not supported in SDF version {version} (added in 1.12)")
        ...
        if _altimeter is not None and cmp_version(version, "1.12") < 0:
            raise ValueError(f"'altimeter' is not supported in SDF version {version} (added in 1.12)")
        ...
        if _lidar is not None and cmp_version(version, "1.12") < 0:
            raise ValueError(f"'lidar' is not supported in SDF version {version} (added in 1.12)")
        ...
        if _logical_camera is not None and cmp_version(version, "1.12") < 0:
            raise ValueError(f"'logical_camera' is not supported in SDF version {version} (added in 1.12)")
        ...
        if _magnetometer is not None and cmp_version(version, "1.12") < 0:
            raise ValueError(f"'magnetometer' is not supported in SDF version {version} (added in 1.12)")
        ...
        if _navsat is not None and cmp_version(version, "1.12") < 0:
            raise ValueError(f"'navsat' is not supported in SDF version {version} (added in 1.12)")
    ...
    def from_sdf(cls, el: ET.Element, version: str) -> "EnableWind":
        ...
        if _enable_wind is not None and cmp_version(version, "1.12") < 0:
            if _enable_wind != False:
                raise ValueError(f"'enable_wind' is not supported in SDF version {version} (added in 1.12)")
...
class Link(Model):
    ...
    def from_sdf(cls, el: ET.Element, version: str) -> "Link":
        ...
        if _battery and cmp_version(version, "1.12") < 0:
            raise ValueError(f"'battery' is not supported in SDF version {version} (added in 1.12)")
        _light = [Light.from_sdf(c, version) for c in el.findall("light")]
        if _light and cmp_version(version, "1.12") < 0:
            raise ValueError(f"'light' is not supported in SDF version {version} (added in 1.12)")
        ...
        if _particle_emitter and cmp_version(version, "1.12") < 0:
            raise ValueError(f"'particle_emitter' is not supported in SDF version {version} (added in 1.12)")
