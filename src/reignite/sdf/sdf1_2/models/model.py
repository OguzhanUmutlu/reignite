...
class Gripper(_PrevGripper):
    ...
    def from_sdf(cls, el: ET.Element) -> "Gripper":
        ...
        return cls(name=_base.name, grasp_check=_base.grasp_check, gripper_link=_base.gripper_link, palm_link=_base.palm_link)
...
class Model(_PrevModel):
    ...
    def from_sdf(cls, el: ET.Element) -> "Model":
        ...
        return cls(name=_base.name, link=_base.link, joint=_base.joint, plugin=_base.plugin, gripper=_base.gripper, static=_base.static, allow_auto_disable=_allow_auto_disable, pose=_pose)
