...
class Joint(_PrevJoint):
    def __init__(
        ...
        super().__init__(name=name, type=type, parent=parent, child=child, thread_pitch=thread_pitch, axis=axis, axis2=axis2, physics=physics)
        self.pose = pose
    ...
    def from_sdf(cls, el: ET.Element) -> "Joint":
        ...
        return cls(name=_base.name, type=_base.type, parent=_base.parent, child=_base.child, pose=_pose, thread_pitch=_base.thread_pitch, axis=_base.axis, axis2=_base.axis2, physics=_base.physics)
