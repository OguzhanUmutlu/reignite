...
class Visual(_PrevVisual):
    def __init__(
        ...
        super().__init__(name=name, geometry=geometry, cast_shadows=cast_shadows, laser_retro=laser_retro,
                         transparency=transparency, material=material)
        self.pose = pose
    ...
    def from_sdf(cls, el: ET.Element) -> "Visual":
        ...
        return cls(name=_base.name, geometry=_base.geometry, cast_shadows=_base.cast_shadows,
                   laser_retro=_base.laser_retro, transparency=_base.transparency, pose=_pose, material=_base.material)
