...
from ...sdf1_9.models.physics import Physics as _PrevPhysics
from ...sdf1_9.models.pose import Pose as _PrevPose
from ...sdf1_9.models.simbody import Simbody as _PrevSimbody
from ...sdf1_9.models.world import World as _PrevWorld
...
class World(_PrevWorld):
    ...
    def from_sdf(cls, el: ET.Element) -> "World":
        ...
        return cls(name=_base.name, atmosphere=_base.atmosphere, gui=_base.gui, physics=_base.physics,
                   scene=_base.scene, light=_base.light, frame=_base.frame, joint=_joint, model=_base.model,
