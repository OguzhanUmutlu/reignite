...
from ...sdf1_9.models.vertical_position import VerticalPosition as _PrevVerticalPosition
...
class VerticalPosition(_PrevVerticalPosition):
    ...
    @classmethod
    def from_sdf(cls, el: ET.Element) -> "VerticalPosition":
        _base = _PrevVerticalPosition.from_sdf(el)
