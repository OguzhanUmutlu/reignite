...
class Joint(_PrevJoint):
    def __init__(
        ...
        super().__init__(name=name, type=type, pose=pose, sensor=sensor, parent=parent, child=child, gearbox_ratio=gearbox_ratio, gearbox_reference_body=gearbox_reference_body, thread_pitch=thread_pitch, axis=axis, axis2=axis2, physics=physics)
    ...
    def from_sdf(cls, el: ET.Element) -> "Joint":
        ...
        _screw_thread_pitch = ScrewThreadPitch.from_sdf(_c_screw_thread_pitch) if _c_screw_thread_pitch is not None else None
        return cls(name=_base.name, type=_base.type, pose=_base.pose, sensor=_base.sensor, parent=_base.parent, child=_base.child, gearbox_ratio=_base.gearbox_ratio, gearbox_reference_body=_base.gearbox_reference_body, thread_pitch=_base.thread_pitch, screw_thread_pitch=_screw_thread_pitch, axis=_base.axis, axis2=_base.axis2, physics=_base.physics)
