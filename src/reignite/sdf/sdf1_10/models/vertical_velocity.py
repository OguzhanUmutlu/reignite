...
from ...sdf1_9.models.vertical_velocity import VerticalVelocity as _PrevVerticalVelocity
...
class VerticalVelocity(_PrevVerticalVelocity):
    ...
    def from_sdf(cls, el: ET.Element) -> "VerticalVelocity":
        _base = _PrevVerticalVelocity.from_sdf(el)
