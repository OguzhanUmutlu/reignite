...
class SphericalCoordinates(_PrevSphericalCoordinates):
    ...
    def from_sdf(cls, el: ET.Element) -> "SphericalCoordinates":
        ...
        _surface_axis_equatorial = SurfaceAxisEquatorial.from_sdf(
            _c_surface_axis_equatorial) if _c_surface_axis_equatorial is not None else None
        _c_surface_axis_polar = el.find("surface_axis_polar")
        _surface_axis_polar = SurfaceAxisPolar.from_sdf(
            _c_surface_axis_polar) if _c_surface_axis_polar is not None else None
        return cls(surface_model=_base.surface_model, world_frame_orientation=_base.world_frame_orientation,
                   ...
                   surface_axis_equatorial=_surface_axis_equatorial, surface_axis_polar=_surface_axis_polar,
