...
from .uri import Uri
from ...sdf1_9.models.include import Include as _PrevInclude
...
class Include(_PrevInclude):
    def __init__(
        ...
        super().__init__(merge=merge, pose=pose, plugin=plugin, uri=uri, name=name, static=static,
    ...
    def from_sdf(cls, el: ET.Element) -> "Include":
        ...
        return cls(merge=_base.merge, pose=_base.pose, plugin=_base.plugin, uri=_base.uri, name=_base.name,
