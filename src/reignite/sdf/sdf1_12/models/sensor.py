...
class Sensor(_PrevSensor):
    ...
    def from_sdf(cls, el: ET.Element) -> "Sensor":
        ...
        return cls(name=_base.name, type=_base.type, pose=_base.pose, plugin=_base.plugin, air_pressure=_base.air_pressure, air_speed=_base.air_speed, altimeter=_base.altimeter, camera=_base.camera, contact=_base.contact, force_torque=_base.force_torque, gps=_base.gps, imu=_base.imu, lidar=_base.lidar, logical_camera=_base.logical_camera, magnetometer=_base.magnetometer, navsat=_base.navsat, ray=_base.ray, rfidtag=_base.rfidtag, rfid=_base.rfid, sonar=_base.sonar, transceiver=_base.transceiver, always_on=_base.always_on, update_rate=_base.update_rate, visualize=_base.visualize, topic=_base.topic, enable_metrics=_base.enable_metrics, frame_id=_frame_id)
