...
from ...sdf1_11.models.constraints import Constraints as _PrevConstraints
...
class Constraints(_PrevConstraints):
    ...
    def from_sdf(cls, el: ET.Element) -> "Constraints":
        ...
        _split_impulse_penetration_threshold = SplitImpulsePenetrationThreshold.from_sdf(
            _c_split_impulse_penetration_threshold) if _c_split_impulse_penetration_threshold is not None else None
        return cls(cfm=_base.cfm, erp=_base.erp, contact_surface_layer=_base.contact_surface_layer,
                   split_impulse=_split_impulse,
                   split_impulse_penetration_threshold=_split_impulse_penetration_threshold)
