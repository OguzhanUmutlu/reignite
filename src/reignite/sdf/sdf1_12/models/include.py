...
class Include(_PrevInclude):
    ...
    def from_sdf(cls, el: ET.Element) -> "Include":
        ...
        return cls(merge=_base.merge, model_state=_model_state, pose=_base.pose, plugin=_base.plugin, uri=_base.uri,
                   name=_base.name, static=_base.static, placement_frame=_base.placement_frame)
