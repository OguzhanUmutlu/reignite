...
from ...sdf1_11.models.imu import Imu as _PrevImu
...
class Imu(_PrevImu):
    def __init__(
        ...
        super().__init__(orientation_reference_frame=orientation_reference_frame, angular_velocity=angular_velocity,
                         linear_acceleration=linear_acceleration, enable_orientation=enable_orientation)
    ...
    def from_sdf(cls, el: ET.Element) -> "Imu":
        ...
        return cls(orientation_reference_frame=_base.orientation_reference_frame,
                   angular_velocity=_base.angular_velocity, linear_acceleration=_base.linear_acceleration,
                   enable_orientation=_base.enable_orientation)
