...
class Cone(BaseModel):
    class Length(BaseModel):
        ...
        def to_version(self, target_version: str) -> "Cone.Length":
        ...
        @classmethod
        def _from_sdf(cls, el: ET.Element, version: str) -> "Cone.Length | SDFError":
            _text = el.text or 1
    ...
    class Radius(BaseModel):
        ...
        def to_version(self, target_version: str) -> "Cone.Radius":
            kwargs = {"sdf_version": target_version}
        ...
        @classmethod
        def _from_sdf(cls, el: ET.Element, version: str) -> "Cone.Radius | SDFError":
            _text = el.text or 1
    ...
    def __init__(
        ...
        length: "Cone.Length" = None,
        radius: "Cone.Radius" = None
    ):
        super().__init__(sdf_version)
        self.length = length
        self.radius = radius
    ...
    @classmethod
    def _from_sdf(cls, el: ET.Element, version: str) -> "Cone | SDFError":
