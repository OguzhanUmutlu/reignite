...
class Light(_PrevLight):
    def __init__(
        ...
        super().__init__(name=name, type=type, cast_shadows=cast_shadows, pose=pose, diffuse=diffuse, specular=specular,
    ...
    def from_sdf(cls, el: ET.Element) -> "Light":
        ...
        return cls(name=_base.name, type=_base.type, cast_shadows=_base.cast_shadows, pose=_base.pose,
