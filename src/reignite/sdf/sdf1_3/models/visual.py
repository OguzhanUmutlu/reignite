...
class Visual(_PrevVisual):
    def __init__(
        ...
        super().__init__(name=name, geometry=geometry, cast_shadows=cast_shadows, laser_retro=laser_retro,
                         transparency=transparency, pose=pose, material=material)
    ...
    def from_sdf(cls, el: ET.Element) -> "Visual":
        ...
        return cls(name=_base.name, geometry=_base.geometry, plugin=_plugin, cast_shadows=_base.cast_shadows,
