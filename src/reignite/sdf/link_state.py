...
class LinkState(BaseModel):
    class Acceleration(BaseModel):
        ...
        def to_version(self, target_version: str) -> "LinkState.Acceleration":
        ...
        @classmethod
        def _from_sdf(cls, el: ET.Element, version: str) -> "LinkState.Acceleration | SDFError":
    ...
    class Force(BaseModel):
        ...
        def to_version(self, target_version: str) -> "LinkState.Force":
            kwargs = {"sdf_version": target_version}
        ...
        @classmethod
        def _from_sdf(cls, el: ET.Element, version: str) -> "LinkState.Force | SDFError":
            _text = el.text or "0 0 0"
    ...
    class LinearAcceleration(BaseModel):
        ...
        def to_version(self, target_version: str) -> "LinkState.LinearAcceleration":
            kwargs = {"sdf_version": target_version}
        ...
        @classmethod
        def _from_sdf(cls, el: ET.Element, version: str) -> "LinkState.LinearAcceleration | SDFError":
            _text = el.text or "0 0 0"
    ...
    class LinearVelocity(BaseModel):
        ...
        def to_version(self, target_version: str) -> "LinkState.LinearVelocity":
            kwargs = {"sdf_version": target_version}
        ...
        @classmethod
        def _from_sdf(cls, el: ET.Element, version: str) -> "LinkState.LinearVelocity | SDFError":
            _text = el.text or "0 0 0"
    ...
    class Torque(BaseModel):
        ...
        def to_version(self, target_version: str) -> "LinkState.Torque":
            kwargs = {"sdf_version": target_version}
        ...
        @classmethod
        def _from_sdf(cls, el: ET.Element, version: str) -> "LinkState.Torque | SDFError":
            _text = el.text or "0 0 0"
    ...
    class Velocity(BaseModel):
        ...
        def to_version(self, target_version: str) -> "LinkState.Velocity":
            kwargs = {"sdf_version": target_version}
        ...
        @classmethod
        def _from_sdf(cls, el: ET.Element, version: str) -> "LinkState.Velocity | SDFError":
            _text = el.text or "0 0 0 0 0 0"
    ...
    class Wrench(BaseModel):
        ...
        def to_version(self, target_version: str) -> "LinkState.Wrench":
            kwargs = {"sdf_version": target_version}
        ...
        @classmethod
        def _from_sdf(cls, el: ET.Element, version: str) -> "LinkState.Wrench | SDFError":
            _text = el.text or "0 0 0 0 0 0"
    ...
    def __init__(
        self,
        sdf_version: str | None = None,
        acceleration: "LinkState.Acceleration" = None,
        ...
        force: "LinkState.Force" = None,
        linear_acceleration: "LinkState.LinearAcceleration" = None,
        linear_velocity: "LinkState.LinearVelocity" = None,
        name: str = "__default__",
        pose: "Pose" = None,
        torque: "LinkState.Torque" = None,
        velocity: "LinkState.Velocity" = None,
        wrench: "LinkState.Wrench" = None
    ):
        super().__init__(sdf_version)
        self.acceleration = acceleration
        self.angular_acceleration = angular_acceleration
