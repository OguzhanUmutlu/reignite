...
from ...sdf1_7.models.noise import Noise as _PrevNoise
from ...sdf1_7.models.camera import Camera as _PrevCamera
...
class Camera(_PrevCamera):
    ...
    def from_sdf(cls, el: ET.Element) -> "Camera":
        ...
        return cls(name=_base.name, pose=_base.pose, camera_info_topic=_base.camera_info_topic, horizontal_fov=_base.horizontal_fov, image=_base.image, clip=_base.clip, save=_base.save, depth_camera=_base.depth_camera, noise=_base.noise, distortion=_base.distortion, lens=_base.lens, visibility_mask=_base.visibility_mask, optical_frame_id=_base.optical_frame_id)
