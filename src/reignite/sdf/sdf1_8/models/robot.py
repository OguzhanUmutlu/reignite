...
from ...sdf1_7.models.robot import Robot as _PrevRobot
...
class Robot(_PrevRobot):
    ...
    def from_sdf(cls, el: ET.Element) -> "Robot":
        ...
        return cls(name=_base.name, link=_base.link, joint=_base.joint, plugin=_base.plugin, gripper=_base.gripper, pose=_base.pose)
