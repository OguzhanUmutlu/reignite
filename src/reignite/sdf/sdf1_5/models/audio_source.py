...
from ...sdf1_4.models.audio_source import AudioSource as _PrevAudioSource
...
class AudioSource(_PrevAudioSource):
    ...
    def from_sdf(cls, el: ET.Element) -> "AudioSource":
        ...
        return cls(frame=_frame, pose=_base.pose, uri=_base.uri, pitch=_base.pitch, gain=_base.gain, contact=_base.contact, loop=_base.loop)
