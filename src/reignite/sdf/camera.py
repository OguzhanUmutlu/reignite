...
class Camera(BaseModel):
    class BoxType(BaseModel):
        ...
        def to_version(self, target_version: str) -> "Camera.BoxType":
        ...
        @classmethod
        def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.BoxType | SDFError":
            _text = el.text or "2d"
            _box_type = _text
    ...
    class CameraInfoTopic(BaseModel):
        ...
        def to_version(self, target_version: str) -> "Camera.CameraInfoTopic":
        ...
        @classmethod
        def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.CameraInfoTopic | SDFError":
    ...
    class Clip(BaseModel):
        class Far(BaseModel):
            ...
            def to_version(self, target_version: str) -> "Camera.Clip.Far":
            ...
            @classmethod
            def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Clip.Far | SDFError":
        ...
        class Near(BaseModel):
            ...
            def to_version(self, target_version: str) -> "Camera.Clip.Near":
            ...
            @classmethod
            def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Clip.Near | SDFError":
                _text = el.text or .1
    ...
    class DepthCamera(BaseModel):
        class DepthCameraClip(BaseModel):
            class ClipFar(BaseModel):
                ...
                def to_version(self, target_version: str) -> "Camera.DepthCamera.DepthCameraClip.ClipFar":
                    kwargs = {"sdf_version": target_version}
                    kwargs["far"] = self.far
                    new_obj = self.__class__(**kwargs)
                    return new_obj
                ...
                @classmethod
                def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.DepthCamera.DepthCameraClip.ClipFar | SDFError":
            ...
            def __init__(
                ...
                far: "Camera.DepthCamera.DepthCameraClip.ClipFar" = None,
                near: "Near" = None
            ):
                super().__init__(sdf_version)
                self.far = far
            ...
            def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.DepthCamera.DepthCameraClip | SDFError":
                ...
                if _c_far is not None:
                    _res = cls.ClipFar._from_sdf(_c_far, version)
        ...
        class Output(BaseModel):
            ...
            def to_version(self, target_version: str) -> "Camera.DepthCamera.Output":
            ...
            @classmethod
            def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.DepthCamera.Output | SDFError":
    ...
    class Distortion(BaseModel):
        class Center(BaseModel):
            ...
            def to_version(self, target_version: str) -> "Camera.Distortion.Center":
                kwargs = {"sdf_version": target_version}
            ...
            @classmethod
            def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Distortion.Center | SDFError":
        ...
        class K1(BaseModel):
            ...
            def to_version(self, target_version: str) -> "Camera.Distortion.K1":
                kwargs = {"sdf_version": target_version}
                kwargs["k1"] = self.k1
                new_obj = self.__class__(**kwargs)
                return new_obj
            ...
            @classmethod
            def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Distortion.K1 | SDFError":
        ...
        class K2(BaseModel):
            ...
            def to_version(self, target_version: str) -> "Camera.Distortion.K2":
                kwargs = {"sdf_version": target_version}
                kwargs["k2"] = self.k2
                new_obj = self.__class__(**kwargs)
                return new_obj
            ...
            @classmethod
            def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Distortion.K2 | SDFError":
                _text = el.text or 0.0
        ...
        class K3(BaseModel):
            ...
            def to_version(self, target_version: str) -> "Camera.Distortion.K3":
                kwargs = {"sdf_version": target_version}
                kwargs["k3"] = self.k3
                new_obj = self.__class__(**kwargs)
                return new_obj
            ...
            @classmethod
            def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Distortion.K3 | SDFError":
                _text = el.text or 0.0
        ...
        class P1(BaseModel):
            ...
            def to_version(self, target_version: str) -> "Camera.Distortion.P1":
                kwargs = {"sdf_version": target_version}
                kwargs["p1"] = self.p1
                new_obj = self.__class__(**kwargs)
                return new_obj
            ...
            @classmethod
            def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Distortion.P1 | SDFError":
                _text = el.text or 0.0
        ...
        class P2(BaseModel):
            ...
            def to_version(self, target_version: str) -> "Camera.Distortion.P2":
                kwargs = {"sdf_version": target_version}
                kwargs["p2"] = self.p2
                new_obj = self.__class__(**kwargs)
                return new_obj
            ...
            @classmethod
            def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Distortion.P2 | SDFError":
                _text = el.text or 0.0
        ...
        def __init__(
            self,
            sdf_version: str | None = None,
            center: "Camera.Distortion.Center" = None,
            k1: "Camera.Distortion.K1" = None,
            k2: "Camera.Distortion.K2" = None,
            k3: "Camera.Distortion.K3" = None,
            p1: "Camera.Distortion.P1" = None,
            p2: "Camera.Distortion.P2" = None
        ):
            super().__init__(sdf_version)
            self.center = center
            self.k1 = k1
        ...
        def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Distortion | SDFError":
            ...
            if _c_k1 is not None:
                _res = cls.K1._from_sdf(_c_k1, version)
                if isinstance(_res, SDFError):
            ...
            if _c_k2 is not None:
                _res = cls.K2._from_sdf(_c_k2, version)
                if isinstance(_res, SDFError):
            ...
            if _c_k3 is not None:
                _res = cls.K3._from_sdf(_c_k3, version)
                if isinstance(_res, SDFError):
            ...
            if _c_p1 is not None:
                _res = cls.P1._from_sdf(_c_p1, version)
                if isinstance(_res, SDFError):
            ...
            if _c_p2 is not None:
                _res = cls.P2._from_sdf(_c_p2, version)
                if isinstance(_res, SDFError):
    ...
    class Image(BaseModel):
        class AntiAliasing(BaseModel):
            ...
            def to_version(self, target_version: str) -> "Camera.Image.AntiAliasing":
            ...
            @classmethod
            def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Image.AntiAliasing | SDFError":
                _text = el.text or 4
        ...
        class Format(BaseModel):
            ...
            def to_version(self, target_version: str) -> "Camera.Image.Format":
            ...
            @classmethod
            def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Image.Format | SDFError":
        ...
        class Height(BaseModel):
            ...
            def to_version(self, target_version: str) -> "Camera.Image.Height":
            ...
            @classmethod
            def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Image.Height | SDFError":
        ...
        class Width(BaseModel):
            ...
            def to_version(self, target_version: str) -> "Camera.Image.Width":
            ...
            @classmethod
            def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Image.Width | SDFError":
        ...
        def __init__(
            self,
            sdf_version: str | None = None,
            anti_aliasing: "Camera.Image.AntiAliasing" = None,
            format: str = "R8G8B8",
            height: int = 240,
            width: int = 320
        ):
        ...
        def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Image | SDFError":
            ...
            if _c_anti_aliasing is not None:
                _res = cls.AntiAliasing._from_sdf(_c_anti_aliasing, version)
                if isinstance(_res, SDFError):
    ...
    class Lens(BaseModel):
        class CustomFunction(BaseModel):
            class C1(BaseModel):
                ...
                def to_version(self, target_version: str) -> "Camera.Lens.CustomFunction.C1":
                    kwargs = {"sdf_version": target_version}
                    kwargs["c1"] = self.c1
                    new_obj = self.__class__(**kwargs)
                    return new_obj
                ...
                @classmethod
                def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Lens.CustomFunction.C1 | SDFError":
                    _text = el.text or 1
            ...
            class C2(BaseModel):
                ...
                def to_version(self, target_version: str) -> "Camera.Lens.CustomFunction.C2":
                    kwargs = {"sdf_version": target_version}
                    kwargs["c2"] = self.c2
                    new_obj = self.__class__(**kwargs)
                    return new_obj
                ...
                @classmethod
                def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Lens.CustomFunction.C2 | SDFError":
                    _text = el.text or 1
            ...
            class C3(BaseModel):
                ...
                def to_version(self, target_version: str) -> "Camera.Lens.CustomFunction.C3":
                    kwargs = {"sdf_version": target_version}
                    kwargs["c3"] = self.c3
                    new_obj = self.__class__(**kwargs)
                    return new_obj
                ...
                @classmethod
                def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Lens.CustomFunction.C3 | SDFError":
                    _text = el.text or 0
            ...
            class F(BaseModel):
                ...
                def to_version(self, target_version: str) -> "Camera.Lens.CustomFunction.F":
                    kwargs = {"sdf_version": target_version}
                    kwargs["f"] = self.f
                    new_obj = self.__class__(**kwargs)
                    return new_obj
                ...
                @classmethod
                def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Lens.CustomFunction.F | SDFError":
                    _text = el.text or 1
            ...
            class Fun(BaseModel):
                ...
                def to_version(self, target_version: str) -> "Camera.Lens.CustomFunction.Fun":
                    kwargs = {"sdf_version": target_version}
                    kwargs["fun"] = self.fun
                    new_obj = self.__class__(**kwargs)
                    return new_obj
                ...
                @classmethod
                def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Lens.CustomFunction.Fun | SDFError":
            ...
            def __init__(
                self,
                sdf_version: str | None = None,
                c1: "Camera.Lens.CustomFunction.C1" = None,
                c2: "Camera.Lens.CustomFunction.C2" = None,
                c3: "Camera.Lens.CustomFunction.C3" = None,
                f: "Camera.Lens.CustomFunction.F" = None,
                fun: "Camera.Lens.CustomFunction.Fun" = None
            ):
                super().__init__(sdf_version)
                self.c1 = c1
                self.c2 = c2
            ...
            def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Lens.CustomFunction | SDFError":
                ...
                if _c_c1 is not None:
                    _res = cls.C1._from_sdf(_c_c1, version)
                    if isinstance(_res, SDFError):
                ...
                if _c_c2 is not None:
                    _res = cls.C2._from_sdf(_c_c2, version)
                    if isinstance(_res, SDFError):
                ...
                if _c_c3 is not None:
                    _res = cls.C3._from_sdf(_c_c3, version)
                    if isinstance(_res, SDFError):
                ...
                _c_f = el.find("f")
                if _c_f is not None:
                    _res = cls.F._from_sdf(_c_f, version)
                    if isinstance(_res, SDFError):
                ...
                if _c_fun is not None:
                    _res = cls.Fun._from_sdf(_c_fun, version)
                    if isinstance(_res, SDFError):
        ...
        class CutoffAngle(BaseModel):
            ...
            def to_version(self, target_version: str) -> "Camera.Lens.CutoffAngle":
                kwargs = {"sdf_version": target_version}
            ...
            @classmethod
            def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Lens.CutoffAngle | SDFError":
        ...
        class EnvTextureSize(BaseModel):
            ...
            def to_version(self, target_version: str) -> "Camera.Lens.EnvTextureSize":
                kwargs = {"sdf_version": target_version}
            ...
            @classmethod
            def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Lens.EnvTextureSize | SDFError":
        ...
        class Intrinsics(BaseModel):
            class Cx(BaseModel):
                ...
                def to_version(self, target_version: str) -> "Camera.Lens.Intrinsics.Cx":
                    kwargs = {"sdf_version": target_version}
                    kwargs["cx"] = self.cx
                    new_obj = self.__class__(**kwargs)
                    return new_obj
                ...
                @classmethod
                def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Lens.Intrinsics.Cx | SDFError":
            ...
            class Cy(BaseModel):
                ...
                def to_version(self, target_version: str) -> "Camera.Lens.Intrinsics.Cy":
                    kwargs = {"sdf_version": target_version}
                    kwargs["cy"] = self.cy
                    new_obj = self.__class__(**kwargs)
                    return new_obj
                ...
                @classmethod
                def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Lens.Intrinsics.Cy | SDFError":
            ...
            class Fx(BaseModel):
                ...
                def to_version(self, target_version: str) -> "Camera.Lens.Intrinsics.Fx":
                    kwargs = {"sdf_version": target_version}
                    kwargs["fx"] = self.fx
                    new_obj = self.__class__(**kwargs)
                    return new_obj
                ...
                @classmethod
                def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Lens.Intrinsics.Fx | SDFError":
            ...
            class Fy(BaseModel):
                ...
                def to_version(self, target_version: str) -> "Camera.Lens.Intrinsics.Fy":
                    kwargs = {"sdf_version": target_version}
                    kwargs["fy"] = self.fy
                    new_obj = self.__class__(**kwargs)
                    return new_obj
                ...
                @classmethod
                def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Lens.Intrinsics.Fy | SDFError":
                    _text = el.text or 277
            ...
            class S(BaseModel):
                ...
                def to_version(self, target_version: str) -> "Camera.Lens.Intrinsics.S":
                    kwargs = {"sdf_version": target_version}
                    kwargs["s"] = self.s
                    new_obj = self.__class__(**kwargs)
                    return new_obj
                ...
                @classmethod
                def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Lens.Intrinsics.S | SDFError":
                    _text = el.text or 0.0
            ...
            def __init__(
                self,
                sdf_version: str | None = None,
                cx: "Camera.Lens.Intrinsics.Cx" = None,
                cy: "Camera.Lens.Intrinsics.Cy" = None,
                fx: "Camera.Lens.Intrinsics.Fx" = None,
                fy: "Camera.Lens.Intrinsics.Fy" = None,
                s: "Camera.Lens.Intrinsics.S" = None
            ):
                super().__init__(sdf_version)
                self.cx = cx
                self.cy = cy
            ...
            def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Lens.Intrinsics | SDFError":
                ...
                if _c_cx is not None:
                    _res = cls.Cx._from_sdf(_c_cx, version)
                    if isinstance(_res, SDFError):
                ...
                if _c_cy is not None:
                    _res = cls.Cy._from_sdf(_c_cy, version)
                    if isinstance(_res, SDFError):
                ...
                if _c_fx is not None:
                    _res = cls.Fx._from_sdf(_c_fx, version)
                    if isinstance(_res, SDFError):
                ...
                if _c_fy is not None:
                    _res = cls.Fy._from_sdf(_c_fy, version)
                    if isinstance(_res, SDFError):
                ...
                _c_s = el.find("s")
                if _c_s is not None:
                    _res = cls.S._from_sdf(_c_s, version)
                    if isinstance(_res, SDFError):
        ...
        class Projection(BaseModel):
            class PCx(BaseModel):
                ...
                def to_version(self, target_version: str) -> "Camera.Lens.Projection.PCx":
                    kwargs = {"sdf_version": target_version}
                ...
                @classmethod
                def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Lens.Projection.PCx | SDFError":
                    _text = el.text or 160
            ...
            class PCy(BaseModel):
                ...
                def to_version(self, target_version: str) -> "Camera.Lens.Projection.PCy":
                    kwargs = {"sdf_version": target_version}
                ...
                @classmethod
                def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Lens.Projection.PCy | SDFError":
                    _text = el.text or 120
            ...
            class PFx(BaseModel):
                ...
                def to_version(self, target_version: str) -> "Camera.Lens.Projection.PFx":
                    kwargs = {"sdf_version": target_version}
                ...
                @classmethod
                def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Lens.Projection.PFx | SDFError":
                    _text = el.text or 277
            ...
            class PFy(BaseModel):
                ...
                def to_version(self, target_version: str) -> "Camera.Lens.Projection.PFy":
                    kwargs = {"sdf_version": target_version}
                ...
                @classmethod
                def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Lens.Projection.PFy | SDFError":
                    _text = el.text or 277
            ...
            class Tx(BaseModel):
                ...
                def to_version(self, target_version: str) -> "Camera.Lens.Projection.Tx":
                    kwargs = {"sdf_version": target_version}
                    kwargs["tx"] = self.tx
                    new_obj = self.__class__(**kwargs)
                    return new_obj
                ...
                @classmethod
                def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Lens.Projection.Tx | SDFError":
                    _text = el.text or 0.0
            ...
            class Ty(BaseModel):
                ...
                def to_version(self, target_version: str) -> "Camera.Lens.Projection.Ty":
                    kwargs = {"sdf_version": target_version}
                    kwargs["ty"] = self.ty
                    new_obj = self.__class__(**kwargs)
                    return new_obj
                ...
                @classmethod
                def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Lens.Projection.Ty | SDFError":
                    _text = el.text or 0.0
            ...
            def __init__(
                self,
                sdf_version: str | None = None,
                p_cx: "Camera.Lens.Projection.PCx" = None,
                p_cy: "Camera.Lens.Projection.PCy" = None,
                p_fx: "Camera.Lens.Projection.PFx" = None,
                p_fy: "Camera.Lens.Projection.PFy" = None,
                tx: "Camera.Lens.Projection.Tx" = None,
                ty: "Camera.Lens.Projection.Ty" = None
            ):
                super().__init__(sdf_version)
                self.p_cx = p_cx
                self.p_cy = p_cy
            ...
            def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Lens.Projection | SDFError":
                ...
                if _c_p_cx is not None:
                    _res = cls.PCx._from_sdf(_c_p_cx, version)
                    if isinstance(_res, SDFError):
                ...
                if _c_p_cy is not None:
                    _res = cls.PCy._from_sdf(_c_p_cy, version)
                    if isinstance(_res, SDFError):
                ...
                if _c_p_fx is not None:
                    _res = cls.PFx._from_sdf(_c_p_fx, version)
                    if isinstance(_res, SDFError):
                ...
                if _c_p_fy is not None:
                    _res = cls.PFy._from_sdf(_c_p_fy, version)
                    if isinstance(_res, SDFError):
                ...
                if _c_tx is not None:
                    _res = cls.Tx._from_sdf(_c_tx, version)
                    if isinstance(_res, SDFError):
                ...
                if _c_ty is not None:
                    _res = cls.Ty._from_sdf(_c_ty, version)
                    if isinstance(_res, SDFError):
        ...
        class ScaleToHfov(BaseModel):
            ...
            def to_version(self, target_version: str) -> "Camera.Lens.ScaleToHfov":
                kwargs = {"sdf_version": target_version}
            ...
            @classmethod
            def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Lens.ScaleToHfov | SDFError":
        ...
        class Type(BaseModel):
            ...
            def to_version(self, target_version: str) -> "Camera.Lens.Type":
                kwargs = {"sdf_version": target_version}
            ...
            @classmethod
            def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Lens.Type | SDFError":
        ...
        def __init__(
            ...
            cutoff_angle: "Camera.Lens.CutoffAngle" = None,
            env_texture_size: "Camera.Lens.EnvTextureSize" = None,
            intrinsics: "Camera.Lens.Intrinsics" = None,
            projection: "Camera.Lens.Projection" = None,
            scale_to_hfov: "Camera.Lens.ScaleToHfov" = None,
            type: "Camera.Lens.Type" = None
        ):
            super().__init__(sdf_version)
        ...
        def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Lens | SDFError":
            ...
            if _c_cutoff_angle is not None:
                _res = cls.CutoffAngle._from_sdf(_c_cutoff_angle, version)
                if isinstance(_res, SDFError):
            ...
            if _c_env_texture_size is not None:
                _res = cls.EnvTextureSize._from_sdf(_c_env_texture_size, version)
                if isinstance(_res, SDFError):
            ...
            if _c_scale_to_hfov is not None:
                _res = cls.ScaleToHfov._from_sdf(_c_scale_to_hfov, version)
                if isinstance(_res, SDFError):
    ...
    class Noise(BaseModel):
        class Mean(BaseModel):
            ...
            def to_version(self, target_version: str) -> "Camera.Noise.Mean":
                kwargs = {"sdf_version": target_version}
            ...
            @classmethod
            def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Noise.Mean | SDFError":
                _text = el.text or 0.0
        ...
        class NoiseType(BaseModel):
            ...
            def to_version(self, target_version: str) -> "Camera.Noise.NoiseType":
                kwargs = {"sdf_version": target_version}
                kwargs["type"] = self.type
                new_obj = self.__class__(**kwargs)
                return new_obj
            ...
            @classmethod
            def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Noise.NoiseType | SDFError":
        ...
        class Stddev(BaseModel):
            ...
            def to_version(self, target_version: str) -> "Camera.Noise.Stddev":
                kwargs = {"sdf_version": target_version}
            ...
            @classmethod
            def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Noise.Stddev | SDFError":
                _text = el.text or 0.0
        ...
        def __init__(
            self,
            sdf_version: str | None = None,
            mean: "Camera.Noise.Mean" = None,
            stddev: "Camera.Noise.Stddev" = None,
            type: "Camera.Noise.NoiseType" = None
        ):
            super().__init__(sdf_version)
            self.mean = mean
            self.stddev = stddev
        ...
        def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Noise | SDFError":
            ...
            _c_type = el.find("type")
            if _c_type is not None:
                _res = cls.NoiseType._from_sdf(_c_type, version)
                if isinstance(_res, SDFError):
                    return _res.extend("type")
                _type = _res
            else:
    ...
    class OpticalFrameId(BaseModel):
        ...
        def to_version(self, target_version: str) -> "Camera.OpticalFrameId":
        ...
        @classmethod
        def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.OpticalFrameId | SDFError":
            _text = el.text or ""
    ...
    class Save(BaseModel):
        class Path(BaseModel):
            ...
            def to_version(self, target_version: str) -> "Camera.Save.Path":
            ...
            @classmethod
            def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Save.Path | SDFError":
                _text = el.text or "__default__"
                _path = _text
    ...
    class SegmentationType(BaseModel):
        ...
        def to_version(self, target_version: str) -> "Camera.SegmentationType":
        ...
        @classmethod
        def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.SegmentationType | SDFError":
    ...
    class TriggerTopic(BaseModel):
        ...
        def to_version(self, target_version: str) -> "Camera.TriggerTopic":
        ...
        @classmethod
        def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.TriggerTopic | SDFError":
            _text = el.text or ""
    ...
    class Triggered(BaseModel):
        ...
        def to_version(self, target_version: str) -> "Camera.Triggered":
        ...
        @classmethod
        def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.Triggered | SDFError":
    ...
    class VisibilityMask(BaseModel):
        ...
        def to_version(self, target_version: str) -> "Camera.VisibilityMask":
        ...
        @classmethod
        def _from_sdf(cls, el: ET.Element, version: str) -> "Camera.VisibilityMask | SDFError":
    ...
    def __init__(
        self,
        sdf_version: str | None = None,
        box_type: "Camera.BoxType" = None,
        camera_info_topic: "Camera.CameraInfoTopic" = None,
        ...
        optical_frame_id: "Camera.OpticalFrameId" = None,
        pose: "Pose" = None,
        save: "Camera.Save" = None,
        segmentation_type: "Camera.SegmentationType" = None,
        trigger_topic: "Camera.TriggerTopic" = None,
        triggered: "Camera.Triggered" = None,
        visibility_mask: "Camera.VisibilityMask" = None
    ):
        super().__init__(sdf_version)
        self.box_type = box_type
        self.camera_info_topic = camera_info_topic
    ...
    def _from_sdf(cls, el: ET.Element, version: str) -> "Camera | SDFError":
        ...
        if _c_box_type is not None:
            _res = cls.BoxType._from_sdf(_c_box_type, version)
            if isinstance(_res, SDFError):
        ...
        if _c_camera_info_topic is not None:
            _res = cls.CameraInfoTopic._from_sdf(_c_camera_info_topic, version)
            if isinstance(_res, SDFError):
        ...
        if _c_optical_frame_id is not None:
            _res = cls.OpticalFrameId._from_sdf(_c_optical_frame_id, version)
            if isinstance(_res, SDFError):
        ...
        if _c_segmentation_type is not None:
            _res = cls.SegmentationType._from_sdf(_c_segmentation_type, version)
            if isinstance(_res, SDFError):
        ...
        if _c_trigger_topic is not None:
            _res = cls.TriggerTopic._from_sdf(_c_trigger_topic, version)
            if isinstance(_res, SDFError):
        ...
        if _c_triggered is not None:
            _res = cls.Triggered._from_sdf(_c_triggered, version)
            if isinstance(_res, SDFError):
